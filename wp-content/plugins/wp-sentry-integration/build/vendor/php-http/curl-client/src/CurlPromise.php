 ...
 */
class CurlPromise implements \WPSentry\ScopedVendor\Http\Promise\Promise
{
    /**
     * Shared promise core.
     *
     ...
     */
    public function __construct(\WPSentry\ScopedVendor\Http\Client\Curl\PromiseCore $core, \WPSentry\ScopedVendor\Http\Client\Curl\MultiRunner $runner)
    {
        $this->core = $core;
        $this->runner = $runner;
    }
