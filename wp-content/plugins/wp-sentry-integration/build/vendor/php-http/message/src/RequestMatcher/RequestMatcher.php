...
use WPSentry\ScopedVendor\Http\Message\RequestMatcher as RequestMatcherInterface;
 ...
 */
final class RequestMatcher implements \WPSentry\ScopedVendor\Http\Message\RequestMatcher
{
    /**
     * @var string
     */
