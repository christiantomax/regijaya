 ...
 */
final class AddPathPlugin implements \WPSentry\ScopedVendor\Http\Client\Common\Plugin
{
    /**
     * @var UriInterface
     */
    private $uri;
    public function __construct(\WPSentry\ScopedVendor\Psr\Http\Message\UriInterface $uri)
    {
        if ('' === $uri->getPath()) {
