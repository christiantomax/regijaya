...
final class Stacktrace
{
    ...
    public function __construct(array $frames)
    {
        ...
        foreach ($frames as $frame) {
            if (!$frame instanceof \Sentry\Frame) {
                throw new \UnexpectedValueException(\sprintf('Expected an instance of the "%s" class. Got: "%s".', \Sentry\Frame::class, \get_debug_type($frame)));
            }
        }
        $this->frames = $frames;
    }
     ...
     */
    public function addFrame(\Sentry\Frame $frame) : void
    {
