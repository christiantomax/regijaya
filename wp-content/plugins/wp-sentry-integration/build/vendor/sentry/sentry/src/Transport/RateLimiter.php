...
final class RateLimiter
{
    ...
    public function handleResponse(\Sentry\Event $event, \WPSentry\ScopedVendor\Psr\Http\Message\ResponseInterface $response) : \Sentry\Response
    {
    ...
    private function handleRateLimit(\WPSentry\ScopedVendor\Psr\Http\Message\ResponseInterface $response) : bool
    {
        $now = \time();
