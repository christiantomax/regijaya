<?php
add_filter( 'rwmb_meta_boxes', 'service_detail_register_meta_boxes' );

function service_detail_register_meta_boxes( $meta_boxes ) {
    $prefix = 'service_detail_';

    $meta_boxes[] = [
        'title'      => esc_html__( 'Service Detail Section', 'online-generator' ),
        'id'         => 'service_detail_section',
        'post_types' => ['page'],
        'context'    => 'normal',
        'autosave'   => true,
        'fields'     => [
